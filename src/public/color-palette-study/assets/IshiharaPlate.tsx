...
export default function IshiharaPlate({ parameters, setAnswer }: IshiharaPlateProps) {
  const { taskid, plateIndex, correctResponse, imagePath } = parameters;
      ...
      <Box style={{ maxWidth: 900, width: '100%' }}>
        <Stack gap="sm" align="center">
            <Text ta="center" style={{ maxWidth: 620 }}>
                Carefully type the number you see using digits (e.g., type "100" not "one hundred").
                If you do not see a number, type <strong>"None"</strong>.
            </Text>
