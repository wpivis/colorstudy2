"""
This script generates LOCALalternatives.json by calling a Colorgorical endpoint in batches and applying LOCAL sectoring (ΔH=20, ΔR=10) to filter candidates. It keeps the top-2 survivors per palette-index. It is the same script as generate_alternatives.py from Study-1.
"""
